...
internal class Player {
     ...
     *         internal int LocationScoreTracker: holds the player's location score tracker
    ...
    /*
     * ===============================================================================================
     * Methods: internal void IncreaseScore(int amount): increases the player's sustainability score and location score by the given amount
    ...
    private class Inventory {
        ...
        internal void Show() {
            ...
            foreach (var item in _inventory) {
                stringVariable += i + ". " + item.Name + " (Value: " + item.Value + ")\n";
                i++;
            }
